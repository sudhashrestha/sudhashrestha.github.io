...
export const projectsData = [
  ...
  },
  {
    ...
    img: 'halth.png',
    title: 'HaltH',
    info: 'HaltH helps the user and their family to start their health journey with nutrition.',
    info2: '',
    features: [
      'Firebase',
      'Rest API',
    ...
    ios: 'https://apps.apple.com/us/app/halth/id1621905859',
  },
  {
    id: nanoid(),
    img: 'opiner_updated.png',
  ...
  },
  {
    ...
    info:
      'The Clinical Ethics app is a simple React Native app built using Expo. It assists bedside clinicians to navigate complex decisions when they face ethical uncertainty in their day to day clinical practice.',
    info2: '',
    features: ['React Native', 'Expo', 'Animation'],
    android: 'https://play.google.com/store/apps/details?id=com.clinicalethics.application',
    ios: 'https://apps.apple.com/us/app/clinical-ethics/id1606123004',
  },
  {
    id: nanoid(),
    img: 'causeway.png',
